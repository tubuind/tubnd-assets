...
import com.astcore.domain.Authority;
import com.astcore.domain.User;
import com.astcore.repository.AuthorityRepository;
...
import com.astcore.service.util.RandomUtil;
...
public class UserService {
    ...
    public Page<UserDTO> search(String query, Pageable pageable) {
        return userRepository.findAllByLoginLike(pageable, String.format("%s%s", query, "%")).map(UserDTO::new);
    }
}
