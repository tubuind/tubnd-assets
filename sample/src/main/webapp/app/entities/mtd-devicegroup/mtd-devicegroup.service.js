(function() {
    ...
    angular
        .module('astcoreApp')
        .factory('MtdDevicegroup', MtdDevicegroup);

    MtdDevicegroup.$inject = ['$resource', 'DateUtils'];

    function MtdDevicegroup ($resource, DateUtils) {
        var resourceUrl =  'api/mtd-devicegroups/:id';
