(function() {
    ...
    angular
        .module('astcoreApp')
        .factory('MtdOrganization', MtdOrganization);

    MtdOrganization.$inject = ['$resource', 'DateUtils'];

    function MtdOrganization ($resource, DateUtils) {
        var resourceUrl =  'api/mtd-organizations/:id';
